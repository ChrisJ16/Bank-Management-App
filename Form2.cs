...
namespace ProiectBRC
{
    public partial class Form2 : Form
    {
        ...
        public Form2(string nume, string prenume, string CNP)
        {
            ...
            sqc.ConnectionString = "server=localhost;user=root;database=bancarproject;port=3306;password=student16";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            sqc.Open();
            MySqlCommand cmd = new MySqlCommand("INSERT INTO persoana(CNP,nume,prenume,adresa,numar_telefon,email,token) " +
                "values (@CNP,@nume,@prenume,@adresa,@numar_telefon,@email,@token)", sqc);
        ...
        {
            int row = Convert.ToInt32(dataGridView5.CurrentCell.RowIndex);
            textBox34.Text = dataGridView5.CurrentCell.Value.ToString();
            textBox1.Text = dataGridView5.Rows[row].Cells[2].Value.ToString();
        }
        ...
        private void button12_Click(object sender, EventArgs e)
        {
            ...
            MySqlCommand cmd1 = new MySqlCommand("Update cont set stare_card_cont=@stat where idCont=@id", sqc);
            cmd1.Parameters.AddWithValue("@stat", "exista");
